...
<div class="title"><h2>人员信息</h2></div>
<div class="table-operate ue-clear">
		<a href="${pageContext.request.contextPath}/admin/user_add.jsp" class="add" onclick="addWork()">添加</a>
</div>
<div class="table-box">
   <table class="table" id="tbRecord">
					...
					<c:forEach items="${user}" var="p"  varStatus="status">
				      <tr class="text-c">
					    ...
					    <td class="text-l">${p.pid}</td>
					    <td class="text-l">${p.address}</td>
						<td class="edit">
						    <button onclick="javascrtpt:window.location.href='${pageContext.request.contextPath}/AdminServlet?method=editUserUI&id=${p.id}'">修改</button>
                        </td>
						</tr>
					</c:forEach>
